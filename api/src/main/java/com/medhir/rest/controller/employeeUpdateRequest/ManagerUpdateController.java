package com.medhir.rest.controller.employeeUpdateRequest;
...
public class ManagerUpdateController {
    ...
    @GetMapping("/{managerId}/members/update-requests")
    public ResponseEntity<List<Map<String, Object>>> getTeamMembersUpdateRequests(
            @PathVariable @NotBlank(message = "Manager ID is required") String managerId) {
        List<EmployeeModel> pendingRequests = employeeUpdateService.getPendingRequestsByManagerId(managerId);
    ...
    @PutMapping("/{managerId}/members/{employeeId}/update-requests")
    public ResponseEntity<Map<String, Object>> approveOrRejectTeamMemberUpdate(
            @PathVariable @NotBlank(message = "Manager ID is required") String managerId,
            @PathVariable @NotBlank(message = "Employee ID is required") String employeeId,
        ...
        if (!managerId.equals(employee.getReportingManager())) {
            return ResponseEntity.badRequest().body(Map.of(
                    "error", "You can only process update requests for your team members"));
        }
