...
import com.medhir.rest.service.IncomeService;
...
import com.medhir.rest.dto.filter.UpdateIncomeStatusRequest;
...
public class IncomeController {
    ...
    public ResponseEntity<IncomeModel> createIncome(@Valid @RequestBody IncomeModel income, BindingResult bindingResult) {
    ...
    public ResponseEntity<List<IncomeModel>> getIncomesByEmployee(@PathVariable String employeeId) {
    ...
    public ResponseEntity<List<IncomeModel>> getIncomesByCompanyAndStatus(
    ...
    public ResponseEntity<List<IncomeModel>> getIncomesByManagerAndStatus(
    ...
    public ResponseEntity<IncomeModel> getIncomeById(@PathVariable String incomeId) {
        Optional<IncomeModel> income = incomeService.getIncomeById(incomeId);
    ...
    public ResponseEntity<IncomeModel> updateIncome(
    ...
    @PutMapping(value = "/updateStatus/{incomeId}", 
                consumes = MediaType.APPLICATION_JSON_VALUE, 
                produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<IncomeModel> updateIncomeStatus(
            @PathVariable String incomeId,
        ...
        try {
            ...
            IncomeModel updatedIncome = incomeService.updateIncomeStatusByHrAdmin(
                incomeId, 
                request.getStatus(),
                request.getRemarks()
            );
    ...
    @PutMapping(value = "/manager/updateStatus/{incomeId}", 
                consumes = MediaType.APPLICATION_JSON_VALUE, 
                produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<IncomeModel> updateIncomeStatusByManager(
            @PathVariable String incomeId,
            @Valid @RequestBody UpdateIncomeStatusRequest request,
            Authentication authentication) {
        try {
            ...
            IncomeModel updatedIncome = incomeService.updateIncomeStatusByManager(
                incomeId, 
                request.getStatus(),
                request.getRemarks(),
                currentUserId
