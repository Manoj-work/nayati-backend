...
//            lead.setLeadId("LID" + snowflakeIdGenerator.nextId());
    ...
    public Optional<LeadModel> getLeadById(String leadId) {
        return leadRepository.findByLeadId(leadId);
    }

    public LeadModel updateLead(String leadId, LeadModel lead) {
        Optional<LeadModel> existingLead = leadRepository.findByLeadId(leadId);
        if (existingLead.isPresent()) {
            LeadModel currentLead = existingLead.get();
    ...
    public void deleteLead(String leadId) {
        Optional<LeadModel> lead = leadRepository.findByLeadId(leadId);
        if (lead.isPresent()) {
            try {
