...
//
//        // 👇 MOCK the mapper output
//        CompanyResponseDTO dto = new CompanyResponseDTO();
//        dto.setName(mockCompany.getName());
//        when(companyMapper.toCompanyResponseDTO(mockCompany)).thenReturn(dto);
//
//        List<CompanyResponseDTO> result = companyService.getAllCompanies();
//
//        assertAll(
//                "Should return mapped company",
//                () -> assertEquals(1, result.size()),
//                () -> assertEquals(mockCompany.getName(), result.get(0).getName())
//        );
//
//        verify(companyRepository).findAll();
//        verify(companyMapper).toCompanyResponseDTO(mockCompany);
//    }
//
//
//    @Test
